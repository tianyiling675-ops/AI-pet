    ...
    >
      ...
      >
        ...
        >
          ...
          <path d="M50 170 Q65 130 85 110 Q72 140 50 170Z" fill="#5a3a1a" />
          <circle cx="100" cy="58" r="3" fill="#5a3a1a" />
          <circle cx="75" cy="88" r="2" fill="#5a3a1a" />
        </svg>
        ...
        >
          ...
          <path d="M140 5 Q110 50 95 75 Q108 45 140 5Z" fill="#5a3a1a" />
          <circle cx="68" cy="98" r="2.5" fill="#5a3a1a" />
          <circle cx="90" cy="78" r="1.5" fill="#5a3a1a" />
        </svg>
        ...
        <div className="relative z-10 px-10 py-12">
          ...
          <div className="mb-8">
            <h1
              className="text-[2rem] font-semibold leading-tight mb-2"
              style={{ color: '#f5e6d0', letterSpacing: '-0.01em', textShadow: '0 1px 8px rgba(0,0,0,0.3)' }}
            >
              先进来坐坐。
            </h1>
            <p className="text-sm" style={{ color: 'rgba(245,220,185,0.75)' }}>
              想说的时候，再开口。
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-[10px] font-bold tracking-[0.25em] uppercase" style={{ color: 'rgba(240,200,145,0.7)' }}>
              登录
            </span>
            <div className="flex-1 h-px" style={{ background: 'rgba(122,92,62,0.2)' }} />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative">
              ...
              <button
                ...
                style={{ color: 'rgba(245,220,185,0.7)' }}
              >
                {showPw ? (
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24M1 1l22 22" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                  </svg>
                ) : (
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl text-sm font-semibold transition-all mt-1 disabled:opacity-60"
              style={{
          ...
          <button
            ...
            disabled
            title="Google 登录暂未开放"
            className="w-full py-3 rounded-xl text-sm font-medium flex items-center justify-center gap-3 opacity-50 cursor-not-allowed"
            style={{
